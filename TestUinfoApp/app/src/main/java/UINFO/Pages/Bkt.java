...
public class Bkt {
    ...
    public Bkt(Stage stage, Kampus kampus, ObservableList<Kampus> datajurusan_fakultas_kampus) {
        this.stage = stage;
        this.kampus = kampus;
        this.datajurusan_fakultas_kampus = datajurusan_fakultas_kampus; // Initialize observableList
    }

    /**
     * Menampilkan tabel dengan detail biaya kuliah tunggal
     */
    ...
    public void show() {
        ...
        TableColumn<Kampus, String> colGolUkt13 = new TableColumn<>("Gol. UKT 1-3");
